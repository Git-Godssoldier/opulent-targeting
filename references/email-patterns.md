...
**Fails when:** it is used as a pretext to send another campaign, or when nobody removes the non-responders afterwards. A re-engagement mail that changes nothing about the list is just another send to people who do not want it, and it costs deliverability for the people who do. See Phase 8 (Deliverability, the law, and the send gate).
